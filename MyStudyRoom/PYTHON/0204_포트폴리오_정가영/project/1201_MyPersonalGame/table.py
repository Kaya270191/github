...
class Table:
    ...
    def __init__(self, window, colour="black", net_colour="green",
        ...
        self.merryboard = self.canvas.create_text(self.width/2, 50, font=font, fill= "darkgreen")
    ...
    def draw_Merry(self, left):
        text = str(left)
        self.canvas.itemconfigure(self.merryboard, text = text)
