...
first_serve = True
bricks=[]
array = ["H","Ha","Hap","Happ","Happy","Happy C","Happy Ch","Happy Chr","Happy Chri","Happy Chris",
         "Happy Christ","Happy Christm","Happy Christma","Happy Christmas"]
...
def game_flow(): #게임진행 함수 
    ...
    for b in bricks:
        ...
        if(b.detect_collision(my_ball, sides_sweet_spot=False) != None):
            ...
            bricks.remove(b)
            my_table.change_color(my_ball.circle,
